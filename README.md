...
PROXY_URL="your_proxy_url" # eg. http://127.0.0.1:7890
```
...
SUMMARY_MODEL="custom_summary_model"  # default gpt-4o-mini, add webpage summary under url (in Chinese, or change prompt in code)
```
